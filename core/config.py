...
class Config(BaseSettings):
    ...
    APP_PORT: int = 8000
    WRITER_DB_URL: str = f"mysql+aiomysql://root:123456@localhost:3306/beta_projectx"
    READER_DB_URL: str = f"mysql+aiomysql://root:123456@localhost:3306/beta_projectx"
